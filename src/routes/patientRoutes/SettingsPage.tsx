...
import LogoutDrawer from '../../components/patientComponents/settings/LogoutDrawer';
import YourProfile from '../../components/patientComponents/settings/YourProfile';
import Files from '../../components/patientComponents/settings/Files';
